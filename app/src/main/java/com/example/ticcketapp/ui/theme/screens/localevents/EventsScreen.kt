        ...
        Column (modifier = Modifier
            ...
            Row {
                ...
                Column {
                    ...
                    Text(text = "CATWALK SHOW", fontSize = 20.sp)
                ...
                Column {
                    ...
                    Text(text = "MAD CARS", fontSize = 20.sp)
                    Text(text = "600 KSH", fontSize = 20.sp)
                    Text(text = "BOOK", fontSize = 20.sp)
                    OutlinedButton(onClick = {
                        val simToolKitLaunchIntent =
                            mContext.packageManager.getLaunchIntentForPackage("com.android.stk")
            ...
            Row {
                ...
                Column {
                    ...
                    Text(text = "SING ALONG", fontSize = 20.sp)
                    ...
                    Column {
                        Image(
                            painter = painterResource(
                                id = R.drawable.ticket
                            ),
                            contentDescription = "shirt",
                            modifier = Modifier.size(width = 180.dp, height = 180.dp)
                        )
                        Text(text = "shirt1", fontSize = 20.sp)
                        Text(text = "ksh1300", fontSize = 20.sp)
                        Text(text = "Pay", fontSize = 20.sp)
                        OutlinedButton(onClick = {
                            val simToolKitLaunchIntent =
                                mContext.packageManager.getLaunchIntentForPackage("com.android.stk")
                            val let = simToolKitLaunchIntent?.let { mContext.startActivity(it) }
